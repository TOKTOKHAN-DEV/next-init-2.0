...
const HistoryIcon = ({ ...props }: IconProps) => {
  return (
    <Icon viewBox="0 0 24 24" fill="none" {...props}>
      <path d="M12.498 6.60699L12.5 12.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M16.852 14.726L12.514 12.556" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
      <path d="M7.52798 9.889H2.92798V5.289" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      <path
