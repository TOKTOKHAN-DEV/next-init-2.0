...
const TextDeleteIcon = ({ ...props }: IconProps) => {
  return (
    <Icon viewBox="0 0 24 24" fill="none" {...props}>
      <path d="M10.606 8.985L15.7876 14.1667" stroke="currentColor" strokeLinecap="round" />
      <path d="M15.788 8.985L10.6063 14.1667" stroke="currentColor" strokeLinecap="round" />
      <path
