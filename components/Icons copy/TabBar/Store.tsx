  ...
  if (variant === 'solid') {
    return (
      <Icon viewBox="0 0 24 24" {...props}>
        ...
        <path d="M21.2759 11.349V20.4301H3.33594V11.36" stroke="white" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
        <path
        ...
        />
        <path d="M8.86194 11.349L9.31394 4" stroke="white" strokeMiterlimit="10" />
        <path d="M15.724 11.342L15.272 4" stroke="white" strokeMiterlimit="10" />
      </Icon>
    );
  }
  return (
    <Icon viewBox="0 0 24 24" fill="none" {...props}>
      <path d="M21.2759 13.478V20.4291H3.33594V13.4861" stroke="currentColor" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
      <path
        ...
        strokeLinejoin="round"
      />
      <path d="M8.86194 11.349L9.31394 4" stroke="currentColor" strokeMiterlimit="10" />
      <path d="M15.724 11.342L15.272 4" stroke="currentColor" strokeMiterlimit="10" />
    </Icon>
  );
};
