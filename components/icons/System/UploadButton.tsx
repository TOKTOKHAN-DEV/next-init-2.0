...
const UploadButtonIcon = ({ ...props }: IconProps) => {
  return (
    <Icon viewBox="0 0 24 24" fill="none" {...props}>
      <path d="M12.2471 7.5V15.166" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round" />
      <path d="M16.0801 11.333H8.41408" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round" />
      <path
